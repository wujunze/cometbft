...
type Header struct {
	...
	// eth block number
	EthBlockNumber int64 `protobuf:"varint,15,opt,name=eth_block_number,json=ethBlockNumber,proto3" json:"eth_block_number,omitempty"`
}
...
func (m *Header) GetEthBlockNumber() int64 {
	if m != nil {
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *Header) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EthBlockNumber != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.EthBlockNumber))
		i--
		dAtA[i] = 0x78
	}
...
func (m *Header) Size() (n int) {
	...
	if m.EthBlockNumber != 0 {
		n += 1 + sovTypes(uint64(m.EthBlockNumber))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EthBlockNumber |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
